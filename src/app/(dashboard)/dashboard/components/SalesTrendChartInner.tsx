...
function ChartSkeleton() {
  return (
    <div className="p-6 rounded-lg border border-border bg-card shadow-[0_1px_3px_0_rgba(0,0,0,0.05)] space-y-4">
      <div className="space-y-2">
        <div className="h-3 w-44 bg-muted/40 rounded animate-pulse" />
        <div className="h-2 w-56 bg-muted/30 rounded animate-pulse" />
      </div>
      <div className="h-48 w-full bg-muted/20 rounded-lg animate-pulse" />
    </div>
  );
}

export function SalesTrendChartInner({ data }: SalesTrendChartProps) {
