    ...
    <Card className="p-8 border-border bg-card max-w-md mx-auto text-center space-y-6 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1)] dark:shadow-[0_4px_20px_-4px_rgba(0,0,0,0.3)] relative overflow-hidden">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 text-left">
        ...
        <Button
          type="submit"
          disabled={isPending}
          className="w-full font-bold text-xs h-10 rounded-lg gap-2 cursor-pointer shadow-sm bg-primary hover:bg-primary/95 text-primary-foreground transition-all duration-200 hover:scale-[1.01]"
        >
